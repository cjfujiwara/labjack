...
fs=[]
fs.append(photodiode("V Sense","USER_RAM0_F32",1.00))
fs.append(photodiode("PID Mode","USER_RAM1_F32",1.00)) 
fs.append(photodiode("V out","USER_RAM2_F32",1.00)) 
